...
CREATE TABLE empleado (
    ...
    nombres VARCHAR(25) NOT NULL,
    apellidos VARCHAR(40) NOT NULL,
    estado ENUM('Habilitado', 'Finiquitado') NOT NULL DEFAULT 'Habilitado',
    fecha_nacimiento DATE NOT NULL,
    email VARCHAR(70) NOT NULL UNIQUE,
    telefono VARCHAR(15) NOT NULL,
    calle VARCHAR(30) NOT NULL,
...
CREATE TABLE descuento_cliente (
    ...
    id_cliente INT NOT NULL,
    codigo_descuento VARCHAR(35) NOT NULL UNIQUE,
    nombre_descuento VARCHAR(100) NOT NULL,
    descripcion text,
    porcentaje DECIMAL(3, 1) NOT NULL,
    estado ENUM('Vigente', 'En espera', 'Utilizado', 'Expirado') NOT NULL DEFAULT 'Expirado',
...
-- Relación Producto con Subcategoria_Producto
ALTER TABLE producto
...
-- Relación Subcategoria_Producto con Categoria_Producto
